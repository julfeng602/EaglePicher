...
SPOOL ../../logs/CustomerOrderExport_&db..log
...
report_name_ varchar2(100) :='Customer Order Export';
...
@Quick_Report_Create  'Warehouse Operations' 'Customer Order Export' "&mysql" 'IFSAPP' 'Export Check Customer Order p: OrderNo'
/
show errors
SPOOL OFF