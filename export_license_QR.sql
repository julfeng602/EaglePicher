...
SPOOL ../../logs/Export_License_&db..log
...
report_name_ varchar2(100) :='Export License';
...
@Quick_Report_Create  'Warehouse Operations' 'Export License' "&mysql" 'IFSAPP' 'Export License p: PartNo'
/
show errors
SPOOL OFF